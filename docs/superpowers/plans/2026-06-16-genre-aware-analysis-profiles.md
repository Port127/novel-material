...
- [x] **Step 5：让 LLM 配置暴露 insight_batch_size**
...
- [x] **Step 3：在 progress 中加入 insights 状态**
...
- [x] **Step 4：在 full 中接入 standard core insights**
...
- [x] **Step 5：在 continue 中接入 insights**
